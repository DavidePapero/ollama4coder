...
- [Come iniziare](#come-iniziare)
    ...
    - [Passo 3: Compila l'immagine Docker](#Passo-3:-Compila-l'immagine-Docker)
    - [Passo 4: Avvia Colibrì](#Passo-4:-Avvia-Colibrì)
...
- **SSD NVMe** (consigliato): 5-15 GB/sec
- **SSD SATA**: 0.5-1 GB/sec
- **Hard disk rotante**: 0.05-0.1 GB/sec ❌ (troppo lento)

Se il tuo disco è lento, le risposte saranno molto lente anche con molta RAM.

---

### Configurazione di default consigliata

Se hai **esattamente 32 GB di RAM** e usi Windows:
...
Lasci 8 GB a Windows e dai 24 GB a WSL + Linux.
